    ...
    <div class="register-box">
      ...
      <el-form ref="registerFormRef" :model="registerForm" :rules="rules" label-width="80px">
        ...
        <el-form-item label="密码" prop="password">
          <el-input type="password" v-model="registerForm.password" placeholder="至少6个字符" prefix-icon="Lock" show-password />
        </el-form-item>
        ...
        <el-form-item label="验证码" prop="code">
          <div class="code-row">
            <el-input v-model="registerForm.code" placeholder="请输入验证码" class="code-input" prefix-icon="Key" />
...
.register-container {
  ...
  align-items: center;
  min-height: 100vh;
  background: linear-gradient(135deg, #0d3b2e 0%, #0f5a3a 25%, #11998e 50%, #0d7377 75%, #0d3b2e 100%);
...
.blob-1 {
  ...
  background: radial-gradient(circle, rgba(56,239,125,0.5), transparent);
  top: -8%; left: -5%;
}
.blob-2 {
  width: 340px; height: 340px;
  background: radial-gradient(circle, rgba(17,153,142,0.45), transparent);
  bottom: -8%; right: -5%;
  animation-delay: -7s; animation-duration: 23s;
}
.blob-3 {
  width: 280px; height: 280px;
  background: radial-gradient(circle, rgba(56,239,125,0.35), transparent);
  top: 45%; left: 55%;
...
.icon {
  ...
  filter: drop-shadow(0 4px 12px rgba(56,239,125,0.35));
}
@keyframes iconFloat {
...
:deep(.register-box .el-input__inner) { color: #fff; }
:deep(.register-box .el-input__inner::placeholder) { color: rgba(255, 255, 255, 0.35); }
:deep(.register-box .el-input__prefix .el-icon) { color: rgba(255, 255, 255, 0.5); }
:deep(.register-box .el-input__suffix .el-icon) { color: rgba(255, 255, 255, 0.5); }
...
.login-link .el-button:hover { color: #38ef7d; }
</style>
